...
export class AIManager {
    ...
    async _generateOpenRouterText(prompt, model, systemInstruction = '', responseFormat = null) {
        ...
        // Add System Instruction if provided (Crucial for strict formatting)
        ...
        try {
            ...
            console.log("[AIManager] OpenRouter Response received. Usage:", data.usage);
            ...
            // --- UNIVERSAL OUTPUT CLEANER ---
            // Remove markdown code blocks if present (common output artifact)
