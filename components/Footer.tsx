    ...
    `}>
            ...
            `}>
                        ...
                        <div className="flex gap-4 pt-1">
                            {/* Instagram */}
                            <a href="#" className={`transition-colors ${isBw ? 'hover:text-white' : 'hover:text-bible-gold'}`} aria-label="Instagram">
                                <Instagram size={18} />
                            </a>

                            {/* Tiktok */}
                            <a href="#" className={`transition-colors ${isBw ? 'hover:text-white' : 'hover:text-bible-gold'}`} aria-label="TikTok">
                            ...
                            {/* X (Twitter) */}
                            <a href="#" className={`transition-colors ${isBw ? 'hover:text-white' : 'hover:text-bible-gold'}`} aria-label="X">
                                <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                            ...
                            {/* YouTube */}
                            <a href="#" className={`transition-colors ${isBw ? 'hover:text-white' : 'hover:text-bible-gold'}`} aria-label="YouTube">
                                <Youtube size={18} />
                            </a>
